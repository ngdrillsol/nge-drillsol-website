...
export default function OperationModule({
  ...
  return (
    <article className="relative h-full overflow-hidden rounded-3xl border border-slate-700/80 bg-[#1B202B] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] sm:p-6">
      ...
      <div className="mt-5 border-t border-white/10 pt-5 sm:mt-6 sm:pt-6">
        ...
        <div className="grid gap-6 md:grid-cols-5">
          ...
          <div className="md:col-span-3 md:border-r md:border-white/10 md:pr-5">
