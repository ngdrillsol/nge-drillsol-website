  ...
  return (
    <>
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="hero-blue-glow absolute left-1/2 top-1/2 h-[900px] w-[900px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/20 blur-[220px]" />
      </div>
      ...
      <div className="pointer-events-none absolute left-1/2 top-[46%] h-[140px] w-[900px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-transparent via-cyan-300/20 to-transparent blur-[40px]" />
