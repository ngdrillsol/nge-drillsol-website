...
export default function KnowledgeHeader() {
  return (
    <div className="mx-auto mb-20 max-w-4xl text-center">
      ...
      >
        Explore engineering guides, country geology reports, drilling
        technologies, project case studies and industry knowledge developed
        through years of real-world drilling experience.
      </motion.p>
    </div>
  );
}