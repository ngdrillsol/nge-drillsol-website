  ...
  return (
    <div className="mx-auto mb-10 max-w-4xl text-center sm:mb-14 lg:mb-20">
      ...
      >
        ...
        <br />
        <span className="text-yellow-400">Drilling Application</span>
      </motion.h2>
      ...
      >
        From deep water wells and mining operations to solar foundations,
        infrastructure and geological exploration, NGE Drillsol delivers
        purpose-built drilling solutions for every industry.
      </motion.p>
    </div>
  );
}
