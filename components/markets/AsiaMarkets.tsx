...
const asianCountries = countryMarkets.filter(
  ...
  return (
    <section className="space-y-14">
      ...
      <div className="text-center">
        ...
        <span className="rounded-full border border-emerald-500/30 bg-emerald-500/10 px-5 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-emerald-400">
          Asia
        </span>

        <h2 className="mt-6 text-5xl font-bold text-white">
          Engineering Solutions for Asia
        </h2>
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        {asianCountries.map((country, index) => (
          ...
          >
            ...
            <Link
              href={country.href}
              className="group block rounded-[30px] border border-white/10 bg-[#090909] p-8 transition-all duration-300 hover:border-emerald-500/30 hover:-translate-y-1"
            >
