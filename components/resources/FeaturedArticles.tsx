...
export default function FeaturedArticles() {
  return (
    <section className="space-y-14">
      ...
      <div className="rounded-[24px] border border-yellow-500/20 bg-gradient-to-r from-[#111827] via-[#0F172A] to-[#111827] p-5 text-center sm:rounded-[28px] sm:p-8 lg:rounded-[32px] lg:p-10">
